...
int main(int argc, char *argv[]) {
    ...
    // Create filename based on L and lambda
    char filename[100];
    sprintf(filename, "escape_prob_L%d_lambda%.2f.txt", L, lambda_rate);
    ...
    printf("Running simulations for L = %d, lambda = %.2f, saving results to %s\n", 
           L, lambda_rate, filename);
    printf("Progress: ");
    
    // Run simulations for 50 values of p from 0.5 to 1
